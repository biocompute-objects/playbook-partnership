...
export const GlycanInformation = MetaNode("GlycanInformation")
  ...
  .story((props) => ({
    ...
    introduction:
      "GlyGen provides information about glycans which are monosaccharides or polysaccharides covalently attached to a protein. Glycan are identifies through GlyTouCan accession and properties like Monoisotopic Mass, Monoisotopic Mass-pMe (Da), Glycan Type / Glycan Subtype are shown. Corresponding glycan image and accessions for PubChem Compound and PubChem Substance are also shown.",
    methods:
      "A search was performed to identify information about the glycan by using the GlyGen database \\ref{doi:10.1093/glycob/cwz080} and the glycan's GlyTouCan accession \\ref{doi:doi: 10.1093/glycob/cwx066}.",
  }))
  .build();
...
export const GlyGenGlycanSet = MetaNode("GGGS")
  ...
  .story((props) => ({
    abstract: `Next, the GlyGen database \\ref{doi:10.1093/glycob/cwz080} was searched to identify a relevant set of glycans that originate from ${props.inputs?.glycan_glytoucan_acc_set.set ? props.inputs.glycan_glytoucan_acc_set.set : "the glycans"}.`,
    introduction:
      "GlyGen provides information about glycans which are monosaccharides or polysaccharides covalently attached to a protein. Glycan are identifies through GlyTouCan accession and properties like Monoisotopic Mass, Monoisotopic Mass-pMe (Da), Glycan Type / Glycan Subtype are shown. Corresponding glycan image and accessions for PubChem Compound and PubChem Substance are also shown.",
    methods:
      "A search was performed to identify information about the glycans by using the GlyGen database \\ref{doi:10.1093/glycob/cwz080} and the glycan's GlyTouCan accessions \\ref{doi:doi: 10.1093/glycob/cwx066}.",
  }))
  .build();
...
export const GlycoenzymeInformation = MetaNode("GlycoenzymeInformation")
  ...
  .story((props) => ({
    abstract: `Next, the GlyGen database \\ref{doi:10.1093/glycob/cwz080} was searched to identify a relevant set of glycans that originate from ${props.inputs?.glyGenGlycanResponse ? props.inputs.glyGenGlycanResponse.glytoucan.glytoucan_ac : "the glycans"}.`,
    introduction:
      "The Glycoenzyme information contains the enzyme information involved in the synthesis of a given glycan. The information consists of UniProtKB ac, Gene name, Protein Name, Organism of the given enzyme.",
    methods:
      "A search was performed to identify the glycoenzyme information in GlyGen \\ref{doi:10.1093/glycob/cwz080} for glycans based on the GlyTouCan accessions \\ref{doi:doi: 10.1093/glycob/cwx066}.",
  }))
  .build();
